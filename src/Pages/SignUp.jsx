            ...
            >
              {({ isSubmitting }) => (
                <Form className="login-form" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  ...
                  <Field className="field" type="text" name="username" id="username" placeholder="UserName" />
                  ...
                  <Field className="field" type="password" name="confirmpassword" id="confirmpassword" placeholder="Confirm Password" />
                  ...
                  <div style={{ color: 'black', fontSize: 16, fontFamily: 'Plus Jakarta Sans', fontWeight: '400', wordWrap: 'break-word', alignSelf: 'center', marginTop: 20 }}>
                    Already have an account? <Link style={{ width: '100%', color: '#4895EF', fontSize: 16, fontFamily: 'Plus Jakarta Sans', fontWeight: '300', wordWrap: 'break-word', cursor: 'pointer' }} to={'/login'}>Login</Link>
                  </div>
                </Form>
              )}
            </Formik>
