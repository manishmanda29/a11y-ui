            ...
            <div style={{ display: 'flex', gap: '20px' }}>
                ...
                <div style={{ flex: 3 }} className='right-side'>
                    <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                        {progressData?.remainedTopics && progressData?.remainedTopics.length === 0 && (
                            <Link to='/certificate'>
                                <button
                                    style={{
                                        alignSelf: 'flex-end',
                                        ...
                                        height: 38,
                                        margin: 10,
                                        background: 'linear-gradient(0deg, #4584FF 0%, #4584FF 100%), linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%)',
                                        borderRadius: 10,
                                        color: 'white',
                                        cursor: 'pointer',
                                    }}
